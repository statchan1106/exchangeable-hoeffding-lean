...
\begin{theorem}[Moment-generating-function bound; Theorem 2.1]
\label{thm:main-mgf}
\lean{SharpSerfling.ExchangeableHoeffding.theorem_2_1_mgf, SharpSerfling.ExchangeableHoeffding.Gamma_isCoefficient}
\leanok
...
\lean{SharpSerfling.ExchangeableHoeffding.theorem_2_1_upperTail}
\leanok
...
\begin{corollary}[Confidence form; Corollary 2.2]
\label{cor:confidence}
\lean{SharpSerfling.ExchangeableHoeffding.corollary_2_2}
\leanok
\uses{thm:upper-tail}
...
\begin{lemma}[Hoeffding's lemma; Lemma 4.1]
\label{lem:hoeffding}
\lean{SharpSerfling.ExchangeableHoeffding.lemma_4_1_hoeffding}
\leanok
...
\begin{lemma}[Hermite sign; Lemma 4.2]
\label{lem:hermite-sign}
\lean{SharpSerfling.ExchangeableHoeffding.lemma_4_2_hermite_sign}
\leanok
...
\begin{lemma}[Three-coordinate section; Lemma 4.3]
\label{lem:three-coordinate}
\lean{SharpSerfling.ExchangeableHoeffding.lemma_4_3_three_coordinate}
\leanok
...
\begin{proposition}[Two-level maximizer; Proposition 4.4]
\label{prop:two-level}
\lean{SharpSerfling.ExchangeableHoeffding.proposition_4_4_two_level}
\leanok
...
\begin{lemma}[Coefficient comparison for Lemma 4.5]
...
\begin{lemma}[Hypergeometric MGF; Lemma 4.5]
\label{lem:hypergeom-mgf}
\lean{SharpSerfling.ExchangeableHoeffding.lemma_4_5_hypergeometric}
\leanok
...
The paper combines Proposition~\ref{prop:two-level}, equation (3.2), and
...
\[
  ...
  \tag{3.1}
\]
This is the mathematical bridge from the Hamming slice to Theorem~2.1.
...
\begin{lemma}[Comparison with the harmonic coefficient; Lemma 4.6]
\label{lem:barber}
\lean{SharpSerfling.ExchangeableHoeffding.harmonicNumber, SharpSerfling.ExchangeableHoeffding.barberEpsilon, SharpSerfling.ExchangeableHoeffding.lemma_4_6, SharpSerfling.ExchangeableHoeffding.lemma_4_6_eq_two}
\leanok
\uses{thm:gamma-closed}
Let
\[
...
\begin{proposition}[Variance lower bound; Proposition 2.3]
\label{prop:variance-lower}
\lean{SharpSerfling.ExchangeableHoeffding.varianceLowerConstant, SharpSerfling.ExchangeableHoeffding.varianceLowerConstant_le_exact, SharpSerfling.ExchangeableHoeffding.proposition_2_3}
\leanok
...
\begin{theorem}[Variational characterization; Remark 2.4]
\label{thm:variational}
\lean{SharpSerfling.ExchangeableHoeffding.paperNormalizedLogMgf_eq, SharpSerfling.ExchangeableHoeffding.variationalConstant_eq_exact_even, SharpSerfling.ExchangeableHoeffding.variationalConstant_eq_exact_odd, SharpSerfling.ExchangeableHoeffding.remark_2_4_variational}
\leanok
